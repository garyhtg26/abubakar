<template>
  <div>
    <div class="row">
      <div
        class="col-4 col-lg-2 col-md-4 col-sm-4 product-card"
        v-for="(x, index) in data"
        :key="`${index}${x.id}`"
      >
        <div class="btn-wishlist">
          <!-- <span class="css-lr6een"> -->
          <!-- <span class="css-gu7dmw"></span>
            <span class="css-y8vkn8 css-1a7a6ct"></span>
            <div data-testid="btnWishlistClickable" class="css-ckbit5"></div> -->
          <!-- </span> -->
          <i
            @click="wish(x)"
            class="icon-wishlist fa fa-heart"
            :style="`color:${x.isWishlist ? 'red' : 'grey'}`"
          ></i>
        </div>
        <router-link class="product-container" :to="'/product/' + x.id">
          <div class="product-wrapper">
            ...
            <div class="css-11s9vse">
              <span class="css-1bjwylw">
                {{ x.name }}
              </span>
              <div class="css-rfiksa" v-if="x.discount_display">
              ...
              <div>
                ...
                >
                  <span class="css-o5uqvq" v-if="x.discount_display">
              ...
              <div class="css-tpww51">
                <div class="css-vbihp9">
                  <span class="css-1kr22w3">{{ x.store }}</span>
    ...
    <b-row v-if="isLoading">
      <b-col cols="6" md="2" v-for="x in 12" :key="x">
