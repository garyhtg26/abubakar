<template>
  <div>
      <Navbar></Navbar>
        <section class="w3l-about1" style="margin-top:85px;">
    <div class="new-block top-bottom">
      <div class="container-fluid p-5">
          <div class="row">
<div class="middle-section col-xs-5" >
          <!-- <h5>Tagline</h5> -->
          <div class="section-width">
            <h1>Perluas Pasar Anda Hari ini</h1>
          </div>
          <div class="link-list-menu">
            <ul>
                                <li>Temukan Jaringan Bisnis Anda</li>
                                <li>Order Datang Dalam Skala Besar</li>
                                <li>Negosiasi Secara Online</li>
                                <li>Membina Kepercayaan Dengan Pembeli</li>
                            </ul>
          </div>
        </div>
        <div class="main-container col-xs-5">
            <form name="signupForm" method="post" autocomplete="off" ng-submit="vm.submitForm(signupForm.$valid)" novalidate="" class="ng-pristine ng-invalid ng-invalid-required ng-valid-minlength ng-valid-email">
            <h2 class="mb-4" style=" text-align: center;font-weight:600; font-size:22px;">Daftar Sebagai Penjual</h2>
            <div class="form-group">
                <label for="name"> Nama Lengkap </label>
                <input autocomplete="off" type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-minlength" id="name" name="name" placeholder=" Nama Lengkap " ng-model="vm.params.name" ng-minlength="3" required="">
               
            </div>
            <div class="form-group">
                <label for="email"> Alamat E-mail </label>
                <input type="email" class="form-control ng-pristine ng-untouched ng-empty ng-valid-email ng-invalid ng-invalid-required" id="email" name="email" placeholder="johndoe@example.com" autocomplete="off" ng-model="vm.params.email" required="" data-ng-blur="vm.checkExistEmail(vm.params.email)">
              
            </div>
            <div class="form-group">
                <label for="password"> Password </label>
                <input autocomplete="off" type="password" class="form-control ng-pristine ng-untouched with-ico-right ng-empty ng-invalid ng-invalid-required ng-valid-minlength" id="password" name="password" placeholder="Password" ng-model="vm.params.password" ng-minlength="6" toggle-password="" required=""><i class="r-icon r-icon_eye"></i>
       
            </div>
            <button style="font-weight:600" type="submit" class="mt-4 btn btn-primary btn-block" ng-disabled="vm.loading">
                <!-- ngIf: vm.loading -->
                Daftar
            </button>
            <a style="font-weight:600" role="button" class="mt-3 btn btn-secondary btn-block" ng-disabled="vm.loading" href="https://sellerpanel.ralali.com/login">
                Masuk Akun
            </a>
            <div class="text-center mt-2">
                Sudah mendaftar tapi belum mendapat email verifikasi? <a class="gtm-resend-email-verification-register text-primary" href="https://sellerpanel.ralali.com/auth/resend-email-verification" target="_blank">Kirim ulang email verifikasi</a>
            </div>
        </form>
        </div>
          </div>
  ...
  <section class="w3l-about2" >
    <div class="features-main py-5">
      <div class="container py-lg-3">
        <h3 class="stat-title center">Kenapa Berjualan di Abubakar?</h3>
  ...
  <section class="w3l-about5" style="background:white!important;">
    <div class="py-5">
      <div class="container py-lg-3">
  ...
  <section class="w3l-about3 py-5" style="background:white!important;">
    <div class="container py-lg-3">
  ...
  <section class="w3l-about4" style="background:white!important;">
  ...
  <!-- about-block6 -->
  <section class="w3l-about6 py-5" style="background:white!important;">
...
.w3l-about1 .new-block {
  ...
  background-image: linear-gradient(to right, rgba(0, 0, 0, 0.57), rgba(0, 0, 0, 0.33)), url(../assets/images/shared-bg.jpg);
...
.w3l-about2 h3.stat-title {
  font-size: 32px;
  line-height: 44px;
  color: #0F0F1A; }

.w3l-about2 .feature-images {
  display: block;
  width: 120px;
  height: 120px;
  line-height: 120px;
  ...
  box-shadow: 0px 9px 24px 5px #e8e8f0;
    background: #fff; }

.w3l-about2 .feature-images span {
  color: #151965;
  display: block;
  font-size: 24px;
  font-weight: bold;
...
.w3l-about2 h3.feature-titel {
  font-size: 24px;
  line-height: 32px;
  font-weight: normal;
  color: #0F0F1A; }

.w3l-about2 p.feature-text {
  color: #6c757d;
  font-weight: 400;
  font-size: 16px;
  line-height: 25px; }
...
.w3l-about3 .timeline li {
  padding: 1em 0; }

.w3l-about3 .timeline li:after {
  content: "";
  display: block;
  height: 0;
  clear: both;
...
.w3l-about3 .direction-l {
  position: relative;
  width: 400px;
  float: left;
  text-align: right; }

.w3l-about3 .direction-r {
  position: relative;
  width: 400px;
  float: right; }

.w3l-about3 .flag-wrapper {
  position: relative;
...
.w3l-about3 .direction-l .flag:before,
.w3l-about3 .direction-r .flag:before {
  position: absolute;
  top: 5px;
  right: -47px;
  content: ' ';
...
.w3l-about4 .contact-main p {
  color: #6c757d;
  font-weight: 400;
  font-size: 16px;
  line-height: 25px; }

.w3l-about4 .contact-para {
  color: var(--para-color);
  line-height: 25px;
  font-size: 16px;
  font-style: normal;
