...
export default {
  ...
  data() {
    return {
      ...
      fieldCatalogs: [
        ...
        { prop: "products_count", label: "Produk", sortable: true },
      ],
      fieldProducts: [
        { prop: "name", label: "Name" },
        { prop: "price", label: "Harga", isPrice: true },
        { prop: "stock", label: "Stok" },
        { prop: "weight", label: "Berat" },
        { prop: "terjual", label: "Terjual" },
        { prop: "reviews", label: "Review" },
        { prop: "rating", label: "Rating" },
      ],
      infoModal: {
        id: "info-modal",
        title: "",
  ...
  methods: {
    ...
    success(index, val) {
      console.log(index);
      if (index == -1) {
        this.catalogs.push(val);
      } else {
        Object.assign(this.catalogs[index], val);
      }
    },
  },
};
